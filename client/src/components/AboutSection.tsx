        ...
        >
          ...
          <div className={`surface-panel-v2 p-9 md:p-14 reveal-from-below ${animation.isVisible ? 'visible' : ''}`}>
            <p className="text-vpfx-text text-lg md:text-xl leading-relaxed mb-9">
              <span className="text-vpfx-accent font-bold">VictoryPipsFX</span> delivers Currency & Precious Metals Intelligence • Learning Materials • Clear Methodology via systematic evaluation.
            </p>
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-9 mb-9">
              {[
                {
                  icon: "📊",
                  title: "Technical Assessment Professionals",
                  description: "Expert chart pattern evaluation"
                },
                {
                  icon: "🌍", 
                  title: "Global Market Intelligence",
                  description: "Learning-focused perspectives internationally"
                },
                {
                  icon: "🎯",
                  title: "Learning Excellence", 
                  description: "Open approach with realistic expectations"
                }
              ].map((item, index) => {
            ...
            <div className="text-center">
              <p className="text-vpfx-text/80 text-base mb-7">
                Connect with 500+ market participants exploring our Intelligence • Study materials exclusively.
              </p>
              ...
              >
                ...
                <span>Connect With Analysis Experts</span>
              </a>
            </div>
          </div>
        </div>
